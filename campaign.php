			...
			<div class="collection-hero">
        		...
        		<div class="collection-hero__title-wrapper"><h1 class="collection-hero__title page-width">Shops</h1></div>
                        ...
                        <div class="grid-products grid--view-items">
                            <div class="row">
							<?php
                              $sql = "SELECT * FROM shop where campaign=1";
                               ...
                               <div class="col-3 item">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="#" class="grid-view-item__link">
                                        <!-- image -->
                                        <img class="primary blur-up lazyload" data-src="<?php echo $row['image']?>" src="<?php echo $row['image']?>" alt="image" title="product" width="250" height="250">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload" data-src="<?php echo $row['image']?>" src="<?php echo $row['image']?>" alt="image" title="product" width="250" height="250">
                                        <!-- End hover image -->
                                        <!-- Variant Image-->
