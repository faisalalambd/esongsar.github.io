                           ...
                           ?>
                                        <tr>
                                            ...
                                            <td> 
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" class="no-margin text-center" name="quantity" value="<?php echo $row['quantity']?>"  readonly>
                                                </div>
                                            </td>
								...
								<?php }}?>
                                    ...
                                    <tfoot class="font-weight-600">
                                        ...
                                        <input name="total" value="<?php echo $total ?>"  type="text" readonly>
                                    </div>
