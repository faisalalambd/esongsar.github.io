<?php  $market_name=$_GET['market_name']?>
        ...
        <div class="container-fluid">
          ...
          <?php include 'side_menu.php'?>
                ...
                <div class="col-12 col-sm-12 col-md-9 col-lg-9 main-col shop-grid-7 style=margin-top:"30px">
                    ...
                    //      $sql = "SELECT * FROM vendor where shop_type='$slug'";
                    //    //   echo $slug;
			...
			<div class="collection-hero">
        		...
        		<div class="collection-hero__title-wrapper"><h1 class="collection-hero__title page-width"><?php echo $market_name?></h1></div>
      		</div>
		</div>
                        <!--End Toolbar-->
                        <div class="grid-products grid--view-items">
							...
							<?php
                              ...
                              $sql = "SELECT * FROM vendor where market_name='$market_name'";
