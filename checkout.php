...
header("location: check.php"); // Redirecting To Profile Page
}
    ...
    <div id="page-content">
    	...
    	<div class="page section-header text-center">
			<div class="page-title">
        		<div class="wrapper"><h1 class="page-width">Check Out</h1></div>
      		</div>
		</div>
        <!--End Page Title-->
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 col-lg-12 col-xl-12 required">
                                        ...
                                        <input name="customer_name" value="<?php echo $name?>" id="input-firstname" type="text">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12 col-lg-12 col-xl-12 required">
                                        ...
                                        <input name="phone" value="<?php echo $login_session?>" id="input-telephone" type="tel">
                                    </div>
                                </div>
                                <div class="row">
                                <div class="form-group col-md-12 col-lg-12 col-xl-12 required">
                                        <label for="input-address-1">Address <span class="required-f">*</span></label>
                                        <input name="address" value="<?php echo $address?>" id="input-address-1" type="text">
                                    </div>
                                </div>
                        ...
                        <div class="your-order">
                           ...
                           ?>
                                        <tr>
                                            ...
                                            <td> <img class="blur-up lazyload zoompro" data-zoom-image="vendor/image/<?php echo $row['product_image']?>" alt="" src="vendor/image/<?php echo $row['product_image']?>"  width="60" height="60"/></td>
                                            <td> 
                                                <div class="form-group ">
                                                    
                                                    <input type="text" class="no-margin text-center" name="quantity" value="<?php echo $quantity?>"  readonly>
                                                </div>
                                            </td>
								...
								<?php }}?>
                                    ...
                                    <tfoot class="font-weight-600">
                                        ...
                                        <input name="total" value="<?php echo $Total_price ?>"  type="text" readonly>
                                    </div>
