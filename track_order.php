    	...
    	<div class="container-fluid">        
            <div class="row align-items-center">
                ...
                <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                	...
                	<nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                        <ul id="siteNav" class="site-nav medium center hidearrow">
                            ...
                            <li class="lvl1 parent dropdown"><a href="index.html">Home<i class="anm anm-angle-down-l"></i></a>
                            ...
                            <li class="lvl1 parent dropdown"><a href="#">Shop<i class="anm anm-angle-down-l"></i></a>
                                <ul class="dropdown">
                                  <li><a href="shop-listview.html" class="site-nav">Shop List</a></li>
                            ...
                            <li class="lvl1 parent dropdown"><a href="#">Product <i class="anm anm-angle-down-l"></i></a>
                                <ul class="dropdown">
                                  <li><a href="short-description.html" class="site-nav">Product View</a></li>
                                  <li><a href="product-pre-orders.html" class="site-nav">Pre-Order Product</a></li>
                                </ul>
                              </li>
                              <li class="lvl1 parent dropdown"><a href="#">Pages <i class="anm anm-angle-down-l"></i></a>
                                <ul class="dropdown">
                                  <li><a href="cart-variant2.html"class="site-nav">Cart View</a></li>
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-block d-lg-none mobile-logo">
                	<div class="logo">
                        <a href="index.html">
                            <img src="assets/images/logo.svg" alt="" title="Belle Multipurpose Html Template" />
                        </a>
                    </div>
                </div>
            	...
            	<div class="col-12 col-sm-12 col-md-3 col-lg-3 sidebar filterbar">
                	...
                	<div class="sidebar_tags">
                    	...
                    	<div class="sidebar_widget categories filter-widget">
                            <div class="widget-title"><h2>Profile</h2></div>
                            <div class="widget-content">
                                <ul class="sidebar_categories">
                                    <li class="lvl-1"><a href="#;" class="site-nav">Edit Profile</a></li>
                                    <li class="lvl-1"><a href="#;" class="site-nav">Your Order</a></li>
                                    <li class="lvl-1"><a href="#;" class="site-nav">Track Orders</a></li>
                ...
                <div class="col-12 col-sm-12 col-md-9 col-lg-9 main-col">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="section-header text-center">
                                            <h2 class="h2">Track Your Order</h2>
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                                                ...
                                                                <div class="row">
                                                                  <div class="text-center col-12 col-sm-12 col-md-12 col-lg-12">
                                                                      <input type="submit" class="btn mb-3" value="Order">
                                                                  </div>
                                                               </div>
                                                           </form>
                                                         </div>   
