          ...
          <div class="card-statistic-4">
            <div class="align-items-center justify-content-between">
              <div class="row ">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                  <div class="card-content">
                    <h5 class="font-15">Total Vendor</h5>
                    <h2 class="mb-3 font-18"><?php echo $vendor?></h2>
            ...
            <div class="table-responsive">
              <table class="table table-striped">
                ...
                <?php
                                   ...
                                   $sql = "SELECT * FROM orders where flag=1 order by id desc";
                                     $result = $conn->query($sql);
                                     if ($result->num_rows > 0) {
                                         // output data of each row
                                         while($row = $result->fetch_assoc()) {
                ...
                <tr style="margin-bottom:20px">
                  ...
                  <td><img src="../vendor/image/<?php echo $row['product_image']?>" alt="Girl in a jacket" width="60" height="60"></td>
